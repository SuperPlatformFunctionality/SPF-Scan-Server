...
ResponseCode.SYSTEM_BUSY     = {code:"0009", msg:"System busy, try later"};
...
ResponseCode.USER_FREE_MINT_LIMITATION_TOTAL 	= {code:"100032", msg:"user free mint limitation total"};      //单一用户free mint总次数限制
ResponseCode.WAIT_FOR_MORE_NTF_RELEASEED 		= {code:"100033", msg:"wait for more NFTs released, thanks"};   //当前nft已经free mint完,等待新的NFT的发布
ResponseCode.ACTIVITY_NOT_STARTED 				= {code:"100034", msg:"activity not started"};   //活动还没有开始
ResponseCode.USER_FREE_MINT_LIMITATION_DIALY	= {code:"100035", msg:"user free mint amount limited to one nft every day"}; //单一用户free mint每天次数限制
ResponseCode.NFT_TYPE_NOT_SUPPORTEED			= {code:"100036", msg:"NFT Type not supported"}; //当前NFT类型不支持
